    ...
    <a href="javascript:history.back()" class="back-button">← Back</a>
        ...
        <div>
            <?php
                ...
                User.FName || ' ' || User.LName AS ProjectManagerName
                    FROM Assignment 
                    LEFT JOIN Project ON Assignment.ProjectID = Project.ProjectID 
                    LEFT JOIN User ON Project.ProjectManager = User.UserID 
                ...
                while ($row = $result->fetchArray(SQLITE3_ASSOC)) {
                    ...
                    //    echo " <a href='delete-project.php?ProjectID=$ProjectID' onclick=\"return confirm('Are you sure you want to delete this project?');\">
